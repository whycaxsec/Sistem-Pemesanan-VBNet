...
Public Class transaksireport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "rumahmakan.transaksireport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trans() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedtransaksireport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As transaksireport = New transaksireport()
        rpt.Site = Me.Site
        Return rpt
    End Function
