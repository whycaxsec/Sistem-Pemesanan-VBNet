...
Public Class transaksireport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "rumahmakan.transaksireport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtransaksireport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As transaksireport2 = New transaksireport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
