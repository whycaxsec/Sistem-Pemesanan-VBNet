...
Public Class Form1
    ...
    End Sub    Sub simpan()
        koneksi()
        Dim sql As String = "insert into tb_costumer values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "')"
    ...
    End Sub    Sub tampil()
        ...
        Try
            koneksi()
            da = New OdbcDataAdapter("select *from tb_costumer order by id_costumer asc",
           con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Else
            If (MessageBox.Show("Anda yakin menghapus data dengan id_costumer=" & a &
           "...?", "Delete", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) =
           Windows.Forms.DialogResult.OK) Then
                koneksi()
                cmd = New OdbcCommand("delete from tb_costumer where id_costumer='" & a &
               "'", con)
                cmd.ExecuteNonQuery()
