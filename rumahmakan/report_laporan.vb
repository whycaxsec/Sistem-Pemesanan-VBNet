...
Public Class report_laporan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "rumahmakan.report_laporan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_laporan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_laporan = New report_laporan()
        rpt.Site = Me.Site
        Return rpt
    End Function
